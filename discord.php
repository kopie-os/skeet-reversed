...
if ($pun_user['g_read_board'] == '0')
 ...
 require __DIR__ . '/vendor/autoload.php';
  ...
  $provider = new \Wohali\OAuth2\Client\Provider\Discord([
      'clientId' => '1186139689707655200', //discord id client
      'clientSecret' => 'L7qfqsJ8F2aXxtGevWtfZE6hG6R4qmt2', //secret discord
      'redirectUri' => 'https://gamesense.cloud/forums/discord.php' // redirect url
  ]);
  $options = [
...
//$discord = new DiscordClient(['token' => 'MTI4NzM0OjFpMmhuZToxMjMxMjM=']); // Token is required

//var_dump($discord->guild->getGuildRoles(['guild.id' => 1096770920321925202, 'name' => "Premium user"]));
...
$client = new DiscordClient([
	 ...
	 // $acceptedRoles = ["Premium User"];
		$client->guild->addGuildMember([
			'guild.id' => 1096770920321925202, //discord server id
			'user.id' => (int)$discord_id,
			'access_token' => (string)$token,
			'nick' => $sessionuser,
			'roles' => array(1096770920321925202,1096789788062924890) //discord roles
			//'roles' => 1096789788062924890, 'name' => 'Premium user', 'color' => 16729413, 'hoist' => true, 'managed' => false, 'mentionable' => true, 'position' => 6, 'permissions' => 37080128)
		]);
